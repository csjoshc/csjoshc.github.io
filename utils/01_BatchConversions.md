...
```
    ...
    [NbConvertApp] Support files will be in ps2-checkpoint_files/
    [NbConvertApp] Making directory ./notes/Python/IntroCompThinkDataSci/unit2/.ipynb_checkpoints/ps2-checkpoint_files
    [NbConvertApp] Making directory ./notes/Python/IntroCompThinkDataSci/unit2/.ipynb_checkpoints/ps2-checkpoint_files
    [NbConvertApp] Writing 13320 bytes to ./notes/Python/IntroCompThinkDataSci/unit2/.ipynb_checkpoints/ps2-checkpoint.md
    ...
    [NbConvertApp] Making directory ./notes/Python/IntroCompThinkDataSci/unit2/ps2_files
    [NbConvertApp] Writing 13276 bytes to ./notes/Python/IntroCompThinkDataSci/unit2/ps2.md
    [NbConvertApp] Converting notebook ./utils/01_BatchConversions.ipynb to markdown
    [NbConvertApp] Writing 2725 bytes to ./utils/01_BatchConversions.md
...
```
      ...
      1159916     16 -rwxrwxrwx   1 jcmint   jcmint      13276 May  1 21:09 ./notes/Python/IntroCompThinkDataSci/unit2/ps2.md
      1157554      4 -rwxrwxrwx   1 jcmint   jcmint       2725 May  1 21:09 ./utils/01_BatchConversions.md
