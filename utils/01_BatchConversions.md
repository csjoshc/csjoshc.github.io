...
```
    ...
    [NbConvertApp] Writing 4902 bytes to ./notes/Python/PythonforDataScience/.ipynb_checkpoints/4_Pandas3-checkpoint.md
    ...
    [NbConvertApp] Writing 20293 bytes to ./notes/Python/PythonforDataScience/.ipynb_checkpoints/4_Pandas4-checkpoint.md
    ...
    [NbConvertApp] Writing 6371 bytes to ./notes/Python/PythonforDataScience/.ipynb_checkpoints/4_pandas5-checkpoint.md
    ...
    [NbConvertApp] Writing 4908 bytes to ./notes/Python/PythonforDataScience/4_Pandas3.md
    ...
    [NbConvertApp] Writing 21168 bytes to ./notes/Python/PythonforDataScience/4_Pandas4.md
    [NbConvertApp] Converting notebook ./notes/Python/PythonforDataScience/4_pandas5.ipynb to markdown
    [NbConvertApp] Writing 7491 bytes to ./notes/Python/PythonforDataScience/4_pandas5.md
    ...
    [NbConvertApp] Writing 3852 bytes to ./utils/01_BatchConversions.md
...
```
      ...
      1157236      4 -rwxrwxrwx   1 jcmint   jcmint       1173 Mar 12 22:43 ./notes/Python/base.md
      1157209      8 -rwxrwxrwx   1 jcmint   jcmint       7559 Mar 11 22:57 ./notes/Python/ProbabilityandStatistics/2_Sets.md
      1155096      8 -rwxrwxrwx   1 jcmint   jcmint       5224 Mar 12 22:48 ./notes/Python/PythonforDataScience/.ipynb_checkpoints/4_Pandas2-checkpoint.md
      1155098      8 -rwxrwxrwx   1 jcmint   jcmint       4902 Mar 12 22:48 ./notes/Python/PythonforDataScience/.ipynb_checkpoints/4_Pandas3-checkpoint.md
      1155113     20 -rwxrwxrwx   1 jcmint   jcmint      20295 Mar 12 22:48 ./notes/Python/PythonforDataScience/.ipynb_checkpoints/4_Pandas4-checkpoint.md
      1155114      8 -rwxrwxrwx   1 jcmint   jcmint       6371 Mar 12 22:48 ./notes/Python/PythonforDataScience/.ipynb_checkpoints/4_pandas5-checkpoint.md
      ...
      1157232      8 -rwxrwxrwx   1 jcmint   jcmint       5224 Mar 12 22:48 ./notes/Python/PythonforDataScience/4_Pandas2.md
      1157386      8 -rwxrwxrwx   1 jcmint   jcmint       4908 Mar 12 22:48 ./notes/Python/PythonforDataScience/4_Pandas3.md
      1154906     24 -rwxrwxrwx   1 jcmint   jcmint      21170 Mar 12 22:48 ./notes/Python/PythonforDataScience/4_Pandas4.md
      1154907      8 -rwxrwxrwx   1 jcmint   jcmint       7491 Mar 12 22:48 ./notes/Python/PythonforDataScience/4_pandas5.md
      1157457      4 -rwxrwxrwx   1 jcmint   jcmint       1026 Mar 12 22:48 ./notes/Python/PythonforDataScience/5_visualization.md
      1157554      4 -rwxrwxrwx   1 jcmint   jcmint       3852 Mar 12 22:48 ./utils/01_BatchConversions.md
