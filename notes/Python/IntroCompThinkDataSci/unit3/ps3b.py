...
class SimpleVirus(object):
    ...
    def __init__(self, maxBirthProb, clearProb):
        ...
        Append the virus to the new list, then append the offspring virus if it reproduces
        """
    ...
    def doesClear(self):
        ...
        False.
        There is a self.getClearProb chance of True, and a 1 - self.getClearProb chance of False
        """
